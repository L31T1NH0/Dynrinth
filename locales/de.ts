...
export const de: typeof en = {
  ...
  search: {
    placeholder:  'Mods, Shader oder Packs suchen...',
  ...
  filters: {
    ...
    sortOptions: {
      ...
      name_az:   'A-Z',
      name_za:   'Z-A',
      least_downloads: 'Wenigste Downloads',
    },
    sources: {
      modrinth:   'Modrinth',
  ...
  rankings: {
    ...
    allDownloads:     'Alle heruntergeladenen Mods',
    backToFiltered:   'Gefiltertes Ranking',
    noVersionBreakdown: 'Noch keine Versionen',
