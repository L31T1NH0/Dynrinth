...
export const pt: typeof en = {
  ...
  search: {
    placeholder:  'Buscar mods, shaders ou packs...',
  ...
  desktopInstall: {
    defaultPath:  'Instala em .minecraft/mods por padrão.',
    installReady: 'Instalar {n} na .minecraft',
    installing:   'Instalando...',
    done:         '{n} arquivo(s) instalado(s) em {path}',
    error:        'Não foi possível instalar em .minecraft/mods',
  },
  ...
  rankings: {
    ...
    allDownloads:     'Todos os mods baixados',
    backToFiltered:   'Ranking filtrado',
    noVersionBreakdown: 'Sem versões ainda',
